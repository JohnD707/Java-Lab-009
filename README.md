...
```text
The *blank* object is mutable because x and y can be changed after the object is called
```
...
```text
#3 is an object and #4 is a double
```
...
```text
p1 and p2 are not aliased because they reference different objects
```
